...
//231334/1411720/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "AD8226ARMZ" (originalName "AD8226ARMZ")
	...
	(compDef "AD8226ARMZ" (originalName "AD8226ARMZ") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "-IN") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "RG_1") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "3" (pinName "RG_2") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "6" (pinName "REF") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "-VS") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "AD8226ARMZ"))
		...
		(attr "Mouser Part Number" "584-AD8226ARMZ")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Analog-Devices/AD8226ARMZ?qs=%2FtpEQrCGXCzt4qnwBCHKiA%3D%3D")
		(attr "Manufacturer_Name" "Analog Devices")
		(attr "Manufacturer_Part_Number" "AD8226ARMZ")
		(attr "Description" "Wide Supply Range, Rail-to-Rail Output Instrumentation Amplifier")
		(attr "<Hyperlink>" "http://www.analog.com/media/en/technical-documentation/data-sheets/AD8226.pdf")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "AD8226ARMZ.stp")
