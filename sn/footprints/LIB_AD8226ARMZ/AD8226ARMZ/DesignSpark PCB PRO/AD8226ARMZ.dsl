...
(library Library_1
	...
	(compDef "AD8226ARMZ" (originalName "AD8226ARMZ") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "2" (pinName "RG_1") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "3" (pinName "RG_2") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(compPin "6" (pinName "REF") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "http://www.analog.com/media/en/technical-documentation/data-sheets/AD8226.pdf")
		(attr "Height" "1.1 mm")
	)
