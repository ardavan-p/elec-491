...
//928198/1411720/2.50/2/2/Capacitor Polarised
...
(library Library_1
	...
	(patternDef "T520Y" (originalName "T520Y")
		(multiLayer
	...
	(symbolDef "T520Y477M006ATE035" (originalName "T520Y477M006ATE035")
	...
	(compDef "T520Y477M006ATE035" (originalName "T520Y477M006ATE035") (compHeader (numPins 2) (numParts 1) (refDesPrefix C)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "T520Y477M006ATE035"))
		(attachedPattern (patternNum 1) (patternName "T520Y")
			(numPads 2)
			(padPinMap
		...
		(attr "Mouser Part Number" "80-T520Y477M6ATE35")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/KEMET/T520Y477M006ATE035?qs=V9LUW0WPRmT0ViN0nxvJ1g%3D%3D")
		(attr "Manufacturer_Name" "KEMET")
		(attr "Manufacturer_Part_Number" "T520Y477M006ATE035")
		(attr "Description" "T520, Tantalum, Polymer Tantalum, Commercial Grade, 470 uF, 20%, 6.3 VDC, 105C, -55C, 105C, SMD, Polymer, Molded, Low ESR, Non-Combustible, 2,000 Hrs, 10 % , 35 mOhms, 296.1 uA, 493.99 mg, 7343, 3.8mm, Height Max = 4mm, 500, 52  Weeks")
		(attr "<Hyperlink>" "https://content.kemet.com/datasheets/KEM_T2076_T52X-530.pdf")
		(attr "<Component Height>" "4")
		(attr "<STEP Filename>" "T520Y477M006ATE035.stp")
