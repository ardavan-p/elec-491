...
(library Library_1
	...
	(patternDef "830064296" (originalName "830064296")
		...
		(layerContents (layerNumRef 28)
			(line (pt -1.7 1.35) (pt 1.7 1.35) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 1.7 1.35) (pt 1.7 -1.35) (width 0.025))
		)
	...
	(compDef "830064296" (originalName "830064296") (compHeader (numPins 4) (numParts 1) (refDesPrefix Y)
		...
		(attr "<Hyperlink>" "https://www.we-online.com/components/products/datasheet/830064296.pdf")
		(attr "<Component Height>" "0.8")
		(attr "<STEP Filename>" "830064296.stp")
